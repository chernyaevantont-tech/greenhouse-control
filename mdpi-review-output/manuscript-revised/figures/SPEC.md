...
- **Width**: 17.5 cm, single panel — widened 2026-08-28. At 8.5 cm the fifteen
  controller labels overlapped each other, and the float was printed at 0.85 of
  the text width anyway, so the labels were sized at one width and shown at
  another. It is now drawn at, and included at, the width it prints.
