# SUMMARY — derived statistics of this results tree
...
| Draw axis: STLSQ control spread (must be 0) | nan | `tables/draws_variance.csv` |
| Variance split, sindy_mpc_conf_dagger | within-seed across draws 1.31 vs between-seed 3.10 EUR/m2 | `tables/draws_variance.csv` |
| Variance split, sindy_mpc_conf | within-seed across draws 1.25 vs between-seed 2.70 EUR/m2 | `tables/draws_variance.csv` |
| Boiler term survives, sindy_mpc_conf | 12% of 200 fits | `tables/draws_boiler_survival.csv` |
| Boiler term survives, sindy_mpc_conf_dagger | 81% of 200 fits | `tables/draws_boiler_survival.csv` |
| P(method leads on a single run), across seed x draw | sindy_mpc_conf_dagger=76%; sindy_mpc_conf=20%; sindy_mpc_dense=4% | `tables/draws_p_leads.csv` |
